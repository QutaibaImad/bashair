...
class AlrusafaChat extends StatefulWidget {
  final String documentId;

  AlrusafaChat({required this.documentId});

  @override
  State<AlrusafaChat> createState() => _AlkarkhChatState();
}

class _AlkarkhChatState extends State<AlrusafaChat> {
  @override
  Widget build(BuildContext context) {
    ...
    getImage() async {
      ...
      if (imageCamera != null) {
        ...
        var refStorage =
            FirebaseStorage.instance.ref('alrusafaChatImages/$imageName');
                                ...
                                onPressed: () async {
                                  ...
                                  if (imageCamera != null) {
                                    ...
                                    var refStorage = FirebaseStorage.instance
                                        .ref('alrusafaChatImages/$imageName');
                                    await refStorage.putFile(file!);
                                    url = await refStorage.getDownloadURL();
                                  }
